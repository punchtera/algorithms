import {
  calculatePairInteger,
  calculatePairIntegerMap,
} from "../src/pairInteger";
...
describe("test calculatePairInteger function", () => {
  it("should return the elements where their difference is equal to the given param", () => {
    ...
    expect(calculatePairInteger(givenArray, givenDifference).length).toEqual(
      expectedPairIntegerArray.length
    );
  });
  ...
  it("should return the elements where their difference is equal to the given param more performant", () => {
    ...
    expect(calculatePairIntegerMap(givenArray, givenDifference).length).toEqual(
      expectedPairIntegerArray.length
    );
  });
});
